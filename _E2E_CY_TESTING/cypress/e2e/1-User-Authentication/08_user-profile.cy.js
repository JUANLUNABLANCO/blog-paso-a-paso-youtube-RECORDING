...
context('Teniendo ualgunos registros creados, vamos a subir una imagen para uno de ellos y ver que accediendo a la página del perfil de ese usuario, tenemos todos sus datos de perfil', () => {
  ...
  beforeEach('1. Limpiar base de datos, 2. crear 25 usuarios aleatorios, 3. create one knowed user, 4. login with this user', ()=>{
    // ## 1
  ...
  it('Guardamos el access_token. Vamos a actualizar este usuario subiendo una imagen de perfil de ejemplo, comprobaremos la imagen', ()=> {
    ...
    // #################################################################################################################
    console.log('## access_token: ', localStorage.getItem('access_token')); // ahora si existe
  ...
  it('Entrar en el perfil del usuario y ver que la imagen se corresponde a la que teníamos previamente', ()=> {
    console.log('queda pendiente hasta que averiüemos como hacer esta comprobación');
  });
