...
context(
  'Teniendo algunos registros creados, vamos a subir una imagen para uno de ellos y ver que accediendo a la página del perfil de ese usuario, tenemos todos sus datos de perfil',
  () => {
